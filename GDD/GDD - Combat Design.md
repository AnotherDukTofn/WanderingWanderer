...
2. [Attributes](#2-attributes)
   ...
   - [2.2. Sub Attributes](#22-sub-attributes)
     ...
     - [2.2.4. Hit & Dodge (AGI)](#224-hit--dodge-agi)
...
5. [Turn Logic & Structure](#5-turn-logic--structure)
   - [5.1. Turn Structure](#51-turn-structure)
     - [5.1.1. Start Phase](#511-start-phase)
     - [5.1.2. Action Phase](#512-action-phase)
     - [5.1.3. End Phase](#513-end-phase)
...
|WISDOM|`WIS`|Yêu cầu **mở Spell Slot** và **Imprint** spell (`minWisdomToImprint` trên từng spell — xem _Game Overview_ / _Spells_). Không dùng trong công thức damage/hit trong combat.|
